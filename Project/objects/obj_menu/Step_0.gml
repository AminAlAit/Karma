	...
	switch(ds_[# 1, menu_option[page]]){
		...
		case menu_element_type.slider:	
			...
			switch(menu_option[page]){
				case 0: if(!audio_is_playing(snd_hit))	{ audio_play_sound(snd_hit, 1, false); } break;
				case 1: if(!audio_is_playing(snd_hit))	{ audio_play_sound(snd_hit,  1, false); } break;
				case 2: if(!audio_is_playing(snd_hit))	{ audio_play_sound(snd_hit,  1, false); } break;
			}
